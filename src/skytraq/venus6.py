...
class Venus6:
  ...
  def __init__(self, serialport, baudrate, debug=True):
    if baudrate == None:
      baudrate = 9600
  ...
  def __gps_time_to_timestamp(week_number, time_of_week):
    #### base time was 1980,1,6
    #refDate = datetime.datetime(1999, 8,22, tzinfo=datetime.timezone.utc)
    # updated to the second epoch to correct which also corrects for the leap seconds
    # as at 2025 (18)
    refDate = datetime.datetime(2019, 4, 6,23,59,42, tzinfo=datetime.timezone.utc)
  ...
  def __decodeFull(data, offset):
    ...
    # wn += 1024 # counter wrapped 1 time in aug 1999
    # wn += 1024 # counter wrapped 2 time in apr 2019
